...
#let titlepage(
  ...
  // title
  align(center, text(weight: "semibold", font: heading-font, 16pt, title))
  ...
  if (type-of-thesis != none and type-of-thesis.len() > 0) {
    align(center, text(weight: "semibold", 11pt, type-of-thesis))
    v(0.5em)
  }
...
*/
  ...
  align(
    ...
    text(
      1.2em,
      [#TITLEPAGE_SUBMITTED.at(language) ] +
  ...
  grid(
    ...
    // course of study
    text(weight: "semibold", TITLEPAGE_COURSE_OF_STUDY.at(language)),
    stack(
      dir: ttb,
      "Operations Research"
    ),
    ...
    // course of study
    text(weight: "semibold", TITLEPAGE_SUBJECT_AREA.at(language)),
    stack(
      dir: ttb,
