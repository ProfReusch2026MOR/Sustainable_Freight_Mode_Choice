...
#figure(
  ...
  caption: [
    ...
    `multimodal_network.json` (870 Hubs) bei konstant 5 Sendungen.
  ],
) <fig:stress-test>
...
Netzwerk `multimodal_network.json`.
...
#figure(
  ...
  caption: [
    ...
    Netzwerk (`dataset/multimodal_network.json`, 870 Hubs). Alle Läufe
...
Monate) und Sendungsmengen (Hunderte bis Tausende).
